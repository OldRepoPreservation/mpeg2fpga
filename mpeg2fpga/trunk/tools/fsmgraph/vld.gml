graph [
 ...
 node [ id 21 label "STATE_ERROR" ]
 node [ id 5 label "STATE_EXTENSION_START_CODE" ]
 node [ id 7 label "STATE_GROUP_HEADER" ]
 node [ id 31 label "STATE_GROUP_HEADER0" ]
 node [ id 27 label "STATE_LD_CHROMA_INTRA_QUANT1" ]
 node [ id 28 label "STATE_LD_CHROMA_NON_INTRA_QUANT1" ]
 node [ id 17 label "STATE_LD_INTRA_QUANT0" ]
 node [ id 25 label "STATE_LD_INTRA_QUANT1" ]
 node [ id 18 label "STATE_LD_NON_INTRA_QUANT0" ]
 node [ id 26 label "STATE_LD_NON_INTRA_QUANT1" ]
 ...
 node [ id 57 label "STATE_NEXT_BLOCK" ]
 node [ id 36 label "STATE_NEXT_MACROBLOCK" ]
 node [ id 45 label "STATE_NEXT_MOTION_VECTOR" ]
 node [ id 1 label "STATE_NEXT_START_CODE" ]
 node [ id 61 label "STATE_NON_CODED_BLOCK" ]
 node [ id 12 label "STATE_PICTURE_CODING_EXT" ]
 node [ id 29 label "STATE_PICTURE_CODING_EXT0" ]
 node [ id 30 label "STATE_PICTURE_CODING_EXT1" ]
 node [ id 3 label "STATE_PICTURE_HEADER" ]
 node [ id 32 label "STATE_PICTURE_HEADER0" ]
 node [ id 33 label "STATE_PICTURE_HEADER1" ]
 node [ id 34 label "STATE_PICTURE_HEADER2" ]
 node [ id 11 label "STATE_QUANT_MATRIX_EXT" ]
 node [ id 10 label "STATE_SEQUENCE_DISPLAY_EXT" ]
 node [ id 22 label "STATE_SEQUENCE_DISPLAY_EXT0" ]
 node [ id 23 label "STATE_SEQUENCE_DISPLAY_EXT1" ]
 node [ id 24 label "STATE_SEQUENCE_DISPLAY_EXT2" ]
 node [ id 6 label "STATE_SEQUENCE_END" ]
 node [ id 9 label "STATE_SEQUENCE_EXT" ]
 node [ id 19 label "STATE_SEQUENCE_EXT0" ]
 node [ id 20 label "STATE_SEQUENCE_EXT1" ]
